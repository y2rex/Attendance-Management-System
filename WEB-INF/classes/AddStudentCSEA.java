...
import java.sql.*;
public class AddStudentCSEA extends HttpServlet
{
...
public void doPost(HttpServletRequest req,HttpServletResponse res)throws IOException,ServletException
  ...
  if(session!=null)
	...
	try
	{
         ...
         String query="insert into attendance_sheet_cse values(?,?,?,?,?,?,?)";
		 ...
		 i=ps.executeUpdate();
		  ...
		  pw.println("<br><a href='FacultyCSEA'>BACK</a>");
		   }
		   else
		   {
		   pw.println("<h1><font color='red'> failed!!!</font></h1>");
		   pw.println("<br><a href='../StudentRegistrationA.html'>Retry</a>");
		   }
		}
else
		{
