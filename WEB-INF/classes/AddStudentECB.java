...
import java.sql.*;
public class AddStudentECB extends HttpServlet
{
...
public void doPost(HttpServletRequest req,HttpServletResponse res)throws IOException,ServletException
  {
   ...
   pw.println("<body><CENTER><div class='container'>");
	...
	try
	{
         ...
         String query="insert into attendance_sheet_ec values(?,?,?,?,?,?,?)";
		 ...
		 i=ps.executeUpdate();
		  ...
		  pw.println("<br><a href='FacultyECB'>BACK</a>");
		   }
		   else
		   {
		   pw.println("<h1><font color='red'> failed!!!</font></h1>");
		   pw.println("<br><a href='../StudentRegistrationECB.html'>Retry</a>");
		   }
