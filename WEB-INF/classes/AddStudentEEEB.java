...
import java.sql.*;
public class AddStudentEEEB extends HttpServlet
{
...
public void doPost(HttpServletRequest req,HttpServletResponse res)throws IOException,ServletException
  {
   ...
   pw.println("<body><CENTER><div class='container'>");
	...
	try
	{
         ...
         String query="insert into attendance_sheet_eee values(?,?,?,?,?,?,?)";
		 ...
		 i=ps.executeUpdate();
		  ...
		  pw.println("<br><a href='FacultyEEEB'>BACK</a>");
		   }
		   else
		   {
		   pw.println("<h1><font color='red'> failed!!!</font></h1>");
		   pw.println("<br><a href='../StudentRegistrationEEEB.html'>Retry</a>");
		   }
