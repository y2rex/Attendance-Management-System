...
public class AdminAttendanceListME extends HttpServlet
{
 Connection con;
 Statement stmt;
 
  public AdminAttendanceListME()
  {
   super();
  }
...
protected void doGet(HttpServletRequest req,HttpServletResponse res)throws IOException,ServletException
 {
	...
	if(session!=null)
   {
			...
			*/
			...
			ResultSet rs1=stmt.executeQuery("select * from attendance_sheet_me order by roll_no asc");
					...
					do
					{
					  ...
					  */
					 ResultSet rs2=stmt.executeQuery("select count(*) from attendance_sheet_me");
					 rs2.next();
					 ...
					 */
					 ...
					 {
					 pw.print("<a href=AdminAttendanceListME?pageno="+k+" style='font-size:100%;font-family:verdana;color:blue;'>"+k+"</a>&nbsp&nbsp&nbsp");
					 }
