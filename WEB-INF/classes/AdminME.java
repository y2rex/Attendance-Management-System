...
public class AdminME extends HttpServlet
{
   public void doGet(HttpServletRequest req,HttpServletResponse res) throws IOException,ServletException
	{
		...
		if(session!=null)
		   ...
		   pw.println("<h1>Admin page</h1>");
		    pw.println("<br><br><br><br><a href=AdminAttendanceListME?pageno=1>Students attendance sheet</a>");
		   pw.println("<a href=../ShortAttendanceAdminME.html><h6>Attendance Report </h6></a><br><br>");
		   pw.println("<a href=../StudentRegistrationME.html><h6>Add Student</h6></a><br><br>");
		   pw.println("<br><a href=../AddfacultyME.html>Add faculty</a>");
		   pw.println("<br><a href=RemoveFacultyME>Remove faculty</a>");	
		    pw.println("<br><br><br><br><br><br><a href=LogoutServlet>Logout</a>");
           }	
        else
		{
