...
public class AttendanceReportECList extends HttpServlet
{
 Connection con;
 Statement stmt;
 
  public AttendanceReportECList()
  {
   super();
  }
			...
			*/
			...
			ResultSet rs1=stmt.executeQuery("select roll_no,sname,semester,attendance from attendance_sheet_ec where attendance between "+a+" and "+b+" order by roll_no asc;");
					 ...
					 */
					 ...
					 {
					 pw.print("<a href=AttendanceReportECList?pageno="+k+" style='font-size:100%;font-family:verdana;color:blue;'>"+k+"</a>&nbsp&nbsp&nbsp");
					 }
