...
public class AttendanceReportEEEList extends HttpServlet
{
 Connection con;
 Statement stmt;
 
  public AttendanceReportEEEList()
  {
   super();
  }
...
protected void doGet(HttpServletRequest req,HttpServletResponse res)throws IOException,ServletException
 {
	...
	if(session!=null)
   {
			...
			*/
			...
			ResultSet rs1=stmt.executeQuery("select roll_no,sname,semester,attendance from attendance_sheet_ec where attendance between "+a+" and "+b+" order by roll_no asc;");
					...
					do
					{
					  ...
					  */
					 ResultSet rs2=stmt.executeQuery("select count(*) from attendance_sheet_ec where  attendance between "+a+" and "+b+";");
					 rs2.next();
					 ...
					 */
					 ...
					 {
					 pw.print("<a href=AttendanceReportEEEList?pageno="+k+" style='font-size:100%;font-family:verdana;color:blue;'>"+k+"</a>&nbsp&nbsp&nbsp");
					 }
				   pw.print("<br><br><br><a href=AdminEEE style='font-size:120%;font-family:verdana;color: #000033;'>HOME PAGE</a>&nbsp&nbsp");
