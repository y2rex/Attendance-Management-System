...
public class DeleteStudentCSE extends HttpServlet
 {
   ...
   try
	{
         ...
         String query="delete from attendance_sheet where roll_no=?";
   ...
   pw.println("<br><a href=AdminAttendanceList>BACK</a>");
   pw.println("</center>");
   pw.println("</body>");
   pw.println("</html>");
   }
