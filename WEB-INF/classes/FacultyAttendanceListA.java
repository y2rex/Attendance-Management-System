...
public class FacultyAttendanceListA extends HttpServlet
{
 Connection con;
 Statement stmt;
 
  public FacultyAttendanceListA()
  {
   super();
  }
...
protected void doGet(HttpServletRequest req,HttpServletResponse res)throws IOException,ServletException
 {
	...
	if(session!=null)
   {
			...
			*/
			...
			ResultSet rs1=stmt.executeQuery("select * from attendance_sheet_cse where roll_no between '14EGJCS001' and '14EGJCS050' order by roll_no;");
					 ...
					 */
					 ...
					 pw.print("<a href=FacultyAttendanceListA?pageno="+k+" style='font-size:100%;font-family:verdana;color:blue;'>"+k+"</a>&nbsp&nbsp&nbsp");
					 }
