...
public class FacultyAttendanceListB extends HttpServlet
{
 Connection con;
 Statement stmt;
 
  public FacultyAttendanceListB()
  {
   super();
  }
...
protected void doGet(HttpServletRequest req,HttpServletResponse res)throws IOException,ServletException
 {
	...
	if(session!=null)
   {
			...
			*/
			...
			ResultSet rs1=stmt.executeQuery("select * from attendance_sheet_cse where roll_no between '14EGJCS051' and '14EGJCS100' order by roll_no asc;");
					 ...
					 */
					 ...
					 {
					 pw.print("<a href=FacultyAttendanceListB?pageno="+k+" style='font-size:100%;font-family:verdana;color:blue;'>"+k+"</a>&nbsp&nbsp&nbsp");
					 }
