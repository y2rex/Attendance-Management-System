...
public class FacultyAttendanceListC extends HttpServlet
{
 Connection con;
 Statement stmt;
 
  public FacultyAttendanceListC()
  {
   super();
  }
...
protected void doGet(HttpServletRequest req,HttpServletResponse res)throws IOException,ServletException
 {
	...
	if(session!=null)
   {
			...
			*/
			...
			ResultSet rs1=stmt.executeQuery("select * from attendance_sheet_cse where roll_no between '14EGJCS101' and '14EGJCS150' order by roll_no asc;");
					...
					do
					{
					  ...
					  */
					 ResultSet rs2=stmt.executeQuery("select count(*) from attendance_sheet_cse where roll_no BETWEEN '14egjcs101' and '14egjcs150';");
					 rs2.next();
					 ...
					 */
					 ...
					 {
					 pw.print("<a href=FacultyAttendanceListC?pageno="+k+" style='font-size:100%;font-family:verdana;color:blue;'>"+k+"</a>&nbsp&nbsp&nbsp");
					 }
