...
public class FacultyAttendanceListECA extends HttpServlet
{
 Connection con;
 Statement stmt;
 
  public FacultyAttendanceListECA()
  {
   super();
  }
...
protected void doGet(HttpServletRequest req,HttpServletResponse res)throws IOException,ServletException
 {
	...
	if(session!=null)
   {
			...
			*/
			...
			ResultSet rs1=stmt.executeQuery("select * from attendance_sheet_ec where roll_no between '14EGJec001' and '14EGJec050' order by roll_no asc;");
					 ...
					 */
					 ...
					 {
					 pw.print("<a href=FacultyAttendanceListECA?pageno="+k+" style='font-size:100%;font-family:verdana;color:blue;'>"+k+"</a>&nbsp&nbsp&nbsp");
					 }
