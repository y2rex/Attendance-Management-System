...
public class FacultyAttendanceListECB extends HttpServlet
{
 Connection con;
 Statement stmt;
 
  public FacultyAttendanceListECB()
  {
   super();
  }
...
protected void doGet(HttpServletRequest req,HttpServletResponse res)throws IOException,ServletException
 {
	...
	if(session!=null)
   {
			...
			*/
			...
			ResultSet rs1=stmt.executeQuery("select * from attendance_sheet_ec where roll_no between '14EGJEC051' and '14EGJEC100' order by roll_no asc;");
					...
					do
					{
					  ...
					  */
					 ResultSet rs2=stmt.executeQuery("select count(*) from attendance_sheet where roll_no BETWEEN '14egjEC051' and '14egjEC100';");
					 rs2.next();
					 ...
					 */
					 ...
					 {
					 pw.print("<a href=FacultyAttendanceListECB?pageno="+k+" style='font-size:100%;font-family:verdana;color:blue;'>"+k+"</a>&nbsp&nbsp&nbsp");
					 }
