...
public class FacultyAttendanceListECC extends HttpServlet
{
 Connection con;
 Statement stmt;
 
  public FacultyAttendanceListECC()
  {
   super();
  }
...
protected void doGet(HttpServletRequest req,HttpServletResponse res)throws IOException,ServletException
 {
	...
	if(session!=null)
   {
			...
			*/
			...
			ResultSet rs1=stmt.executeQuery("select * from attendance_sheet_ec where roll_no between '14EGJEC101' and '14EGJEC150' order by roll_no asc;");
					...
					do
					{
					  ...
					  */
					 ResultSet rs2=stmt.executeQuery("select count(*) from attendance_sheet where roll_no BETWEEN '14egjEC101' and '14egjEC150';");
					 rs2.next();
					 ...
					 */
					 ...
					 {
					 pw.print("<a href=FacultyAttendanceListECC?pageno="+k+" style='font-size:100%;font-family:verdana;color:blue;'>"+k+"</a>&nbsp&nbsp&nbsp");
					 }
