...
public class FacultyAttendanceListEEEA extends HttpServlet
{
 Connection con;
 Statement stmt;
 
  public FacultyAttendanceListEEEA()
  {
   super();
  }
...
protected void doGet(HttpServletRequest req,HttpServletResponse res)throws IOException,ServletException
 {
	...
	if(session!=null)
   {
			...
			*/
			...
			ResultSet rs1=stmt.executeQuery("select * from attendance_sheet_eee where roll_no between '14EGJEE001' and '14EGJEE050' order by roll_no asc;");
					...
					do
					{
					  ...
					  */
					 ResultSet rs2=stmt.executeQuery("select count(*) from attendance_sheet_eee where roll_no BETWEEN '14egjEE001' and '14egjEE050';");
					 rs2.next();
					 ...
					 */
					 ...
					 {
					 pw.print("<a href=FacultyAttendanceListEEEA?pageno="+k+" style='font-size:100%;font-family:verdana;color:blue;'>"+k+"</a>&nbsp&nbsp&nbsp");
					 }
