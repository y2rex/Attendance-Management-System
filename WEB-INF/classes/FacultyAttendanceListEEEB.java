...
public class FacultyAttendanceListEEEB extends HttpServlet
{
 Connection con;
 Statement stmt;
 
  public FacultyAttendanceListEEEB()
  {
   super();
  }
...
protected void doGet(HttpServletRequest req,HttpServletResponse res)throws IOException,ServletException
 {
	...
	if(session!=null)
   {
			...
			*/
			...
			ResultSet rs1=stmt.executeQuery("select * from attendance_sheet_EEE where roll_no between '14EGJEE051' and '14EGJEE100' order by roll_no ASC;");
					 ...
					 */
					 ...
					 {
					 pw.print("<a href=FacultyAttendanceListEEEB?pageno="+k+" style='font-size:100%;font-family:verdana;color:blue;'>"+k+"</a>&nbsp&nbsp&nbsp");
					 }
