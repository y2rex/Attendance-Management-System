...
public class FacultyAttendanceListEEEC extends HttpServlet
{
 Connection con;
 Statement stmt;
 
  public FacultyAttendanceListEEEC()
  {
   super();
  }
...
protected void doGet(HttpServletRequest req,HttpServletResponse res)throws IOException,ServletException
 {
	...
	if(session!=null)
   {
			...
			*/
			...
			ResultSet rs1=stmt.executeQuery("select * from attendance_sheet_EEE where roll_no between '14EGJEE101' and '14EGJCS150' order by roll_no ASC;");
					 ...
					 i++;
						...
						String s5 = rs1.getString(5);
						 ...
						 pw.println("<tr>");
							  ...
							  pw.println("<td>"+s4+"</td>");
							  pw.println("<td>"+s5+"</td>");
							  pw.println("<td><a href=FacultyEditStudentDetails?id1="+s1+">Edit</a></td>");
						 pw.println("</tr>");	
					 ...
					 */
					 ...
					 {
					 pw.print("<a href=FacultyAttendanceListEEEC?pageno="+k+" style='font-size:100%;font-family:verdana;color:blue;'>"+k+"</a>&nbsp&nbsp&nbsp");
					 }
