...
public class FacultyAttendanceListMEA extends HttpServlet
{
 Connection con;
 Statement stmt;
 
  public FacultyAttendanceListMEA()
  {
   super();
  }
...
protected void doGet(HttpServletRequest req,HttpServletResponse res)throws IOException,ServletException
 {
	...
	if(session!=null)
   {
			...
			*/
			...
			ResultSet rs1=stmt.executeQuery("select * from attendance_sheet_me where roll_no between '14EGJme001' and '14EGJme050' order by roll_no asc;");
					 ...
					 */
					 ...
					 {
					 pw.print("<a href=FacultyAttendanceListMEA?pageno="+k+" style='font-size:100%;font-family:verdana;color:blue;'>"+k+"</a>&nbsp&nbsp&nbsp");
					 }
