...
public class FacultyAttendanceListMEB extends HttpServlet
{
 Connection con;
 Statement stmt;
 
  public FacultyAttendanceListMEB()
  {
   super();
  }
...
protected void doGet(HttpServletRequest req,HttpServletResponse res)throws IOException,ServletException
 {
	...
	if(session!=null)
   {
			...
			*/
			...
			ResultSet rs1=stmt.executeQuery("select * from attendance_sheet_me where roll_no between '14EGJME051' and '14EGJME100' order by roll_no ASC;");
					 ...
					 */
					 ...
					 {
					 pw.print("<a href=FacultyAttendanceListMEB?pageno="+k+" style='font-size:100%;font-family:verdana;color:blue;'>"+k+"</a>&nbsp&nbsp&nbsp");
					 }
