...
public class FacultyAttendanceListMEC extends HttpServlet
{
 Connection con;
 Statement stmt;
 
  public FacultyAttendanceListMEC()
  {
   super();
  }
...
protected void doGet(HttpServletRequest req,HttpServletResponse res)throws IOException,ServletException
 {
	...
	if(session!=null)
   {
			...
			*/
			...
			ResultSet rs1=stmt.executeQuery("select * from attendance_sheet_ME where roll_no between '14EGJME101' and '14EGJME150' order by roll_no ASC;");
					 ...
					 */
					 ...
					 {
					 pw.print("<a href=FacultyAttendanceListMEC?pageno="+k+" style='font-size:100%;font-family:verdana;color:blue;'>"+k+"</a>&nbsp&nbsp&nbsp");
					 }
