...
import java.io.*;
public class FacultyCSEB extends HttpServlet
{
  public void doGet(HttpServletRequest req,HttpServletResponse res) throws IOException,ServletException
   {
		...
		if(session!=null)
		{
			pw.println("<br><br><br><a href=FacultyAttendanceListB?pageno=1>Attendance list</a><br><br>");
			pw.println("<br><br><a href=../StudentRegistrationB.html>Add Student</a><br><br>");
			pw.println("<br><br><br><a href=../ShortAttendanceListFacultyB.html><i>Short attendance list</i></a>");
