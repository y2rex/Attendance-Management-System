...
import java.io.*;
import java.sql.*;
public class FacultyEC extends HttpServlet
{
	 ...
	 if(flag==1 && section.equalsIgnoreCase(s3))
			  {	  		
                    if(section.equalsIgnoreCase("a"))			  
					  res.sendRedirect("FacultyECA");
					  
					 else if(section.equalsIgnoreCase("b"))			  
					  res.sendRedirect("FacultyECB");
					  
					 else if(section.equalsIgnoreCase("c"))			  
					  res.sendRedirect("FacultyECC");
					  
				     else if(section.equalsIgnoreCase("d"))			  
					  res.sendRedirect("FacultyECD");
				}
