...
import java.io.*;
public class FacultyECB extends HttpServlet
{
  public void doGet(HttpServletRequest req,HttpServletResponse res) throws IOException,ServletException
   {
		...
		if(session!=null)
		{
			pw.println("<br><br><br><a href=FacultyAttendanceListECB?pageno=1>Attendance list</a><br><br>");
			pw.println("<br><br><a href=../StudentRegistrationECB.html>Add Student</a><br><br>");
			pw.println("<br><br><br><a href=../ShortAttendanceListFacultyECB.html><i>Short attendance list</i></a>");
