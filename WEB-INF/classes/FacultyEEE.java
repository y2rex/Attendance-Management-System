...
import java.io.*;
import java.sql.*;
public class FacultyEEE extends HttpServlet
{
	 ...
	 if(flag==1 && section.equalsIgnoreCase(s3))
			  {	  		
                    if(section.equalsIgnoreCase("a"))			  
					  res.sendRedirect("FacultyEEEA");
					  
					 else if(section.equalsIgnoreCase("b"))			  
					  res.sendRedirect("FacultyEEEB");
					  
					 else if(section.equalsIgnoreCase("c"))			  
					  res.sendRedirect("FacultyEEEC");
					  
				     else if(section.equalsIgnoreCase("d"))			  
					  res.sendRedirect("FacultyEEED");
				}
					...
					pw.println("<a href='FacultyEC'> Select section </a>");
					}	  
