...
import java.io.*;
public class FacultyEEEA extends HttpServlet
{
  public void doGet(HttpServletRequest req,HttpServletResponse res) throws IOException,ServletException
   {
		...
		if(session!=null)
		{
			pw.println("<br><br><br><a href=FacultyAttendanceListEEEA?pageno=1>Attendance list</a><br><br>");
			pw.println("<br><br><a href=../StudentRegistrationEEEA.html>Add Student</a><br><br>");
			pw.println("<br><br><br><a href=../ShortAttendanceListFacultyEEEA.html><i>Short attendance list</i></a>");
