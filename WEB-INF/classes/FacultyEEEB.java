...
import java.io.*;
public class FacultyEEEB extends HttpServlet
{
  public void doGet(HttpServletRequest req,HttpServletResponse res) throws IOException,ServletException
   {
		...
		if(session!=null)
		{
			pw.println("<br><br><br><a href=FacultyAttendanceListEEEB?pageno=1>Attendance list</a><br><br>");
			pw.println("<br><br><a href=../StudentRegistrationEEEB.html>Add Student</a><br><br>");
			pw.println("<br><br><br><a href=../ShortAttendanceListFacultyEEEB.html><i>Short attendance list</i></a>");
