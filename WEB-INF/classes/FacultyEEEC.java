...
import java.io.*;
public class FacultyEEEC extends HttpServlet
{
  public void doGet(HttpServletRequest req,HttpServletResponse res) throws IOException,ServletException
   {
		...
		if(session!=null)
		{
			pw.println("<br><br><br><a href=FacultyAttendanceListEEEC?pageno=1>Attendance list</a><br><br>");
			pw.println("<br><br><a href=../StudentRegistrationEEEC.html>Add Student</a><br><br>");
			pw.println("<br><br><br><a href=../ShortAttendanceListFacultyEEEC.html><i>Short attendance list</i></a>");
