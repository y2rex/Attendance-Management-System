...
import java.io.*;
import java.sql.*;
public class FacultyME extends HttpServlet
{
	 ...
	 if(flag==1 && section.equalsIgnoreCase(s3))
			  {	  		
                    if(section.equalsIgnoreCase("a"))			  
					  res.sendRedirect("FacultyMEA");
					  
					 else if(section.equalsIgnoreCase("b"))			  
					  res.sendRedirect("FacultyMEB");
					  
					 else if(section.equalsIgnoreCase("c"))			  
					  res.sendRedirect("FacultyMEC");
					  
				     else if(section.equalsIgnoreCase("d"))			  
					  res.sendRedirect("FacultyMED");
				}
					...
					pw.println("<a href='FacultyME'> Select section </a>");
					}	  
