...
import java.io.*;
public class FacultyMEA extends HttpServlet
{
  public void doGet(HttpServletRequest req,HttpServletResponse res) throws IOException,ServletException
   {
		...
		String s1=(String)session.getAttribute("un");
			pw.println("<br><br><br><a href=FacultyAttendanceListMEA?pageno=1>Attendance list</a><br><br>");
			pw.println("<br><br><a href=../StudentRegistrationMEA.HTML>Add Student</a><br><br>");
			pw.println("<br><br><br><a href=../ShortAttendanceListFacultyMEA.html><i>Short attendance list</i></a>");
