...
import java.io.*;
public class FacultyMEB extends HttpServlet
{
  public void doGet(HttpServletRequest req,HttpServletResponse res) throws IOException,ServletException
   {
		...
		String s1=(String)session.getAttribute("un");
			pw.println("<br><br><br><a href=FacultyAttendanceListMEB?pageno=1>Attendance list</a><br><br>");
			pw.println("<br><br><a href=../StudentRegistrationMEB.html>Add Student</a><br><br>");
			pw.println("<br><br><br><a href=../ShortAttendanceListFacultyMEB.html><i>Short attendance list</i></a>");
