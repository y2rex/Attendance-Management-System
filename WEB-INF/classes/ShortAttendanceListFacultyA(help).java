...
public class ShortAttendanceListFacultyA extends HttpServlet
{
 Connection con;
 Statement stmt;
 
  public ShortAttendanceListFacultyA()
  {
   super();
  }
...
protected void doGet(HttpServletRequest req,HttpServletResponse res)throws IOException,ServletException
 {
	...
	HttpSession session=req.getSession(false);
	        int l=Integer.parseInt((String)session.getAttribute("ll"));
			int u=Integer.parseInt((String)session.getAttribute("ul"));
	...
	if(session!=null)
   {
			...
			*/
			...
			ResultSet rs1=stmt.executeQuery("select roll_no,sname,semester,attendance from attendance_sheet where attendance between l and u and roll_no between '14egjcs001' and '14egjcs050' order by attendance desc;");
					...
					do
					{
					  ...
					  */
					 ResultSet rs2=stmt.executeQuery("select count(*) from attendance_sheet where attendance between l and u;");
					 rs2.next();
					 ...
					 */
					 ...
					 {
					 pw.print("<a href=ShortAttendanceListFacultyA?pageno="+k+" style='font-size:100%;font-family:verdana;color:blue;'>"+k+"</a>&nbsp&nbsp&nbsp");
					 }
				   pw.print("<br><br><br><a href=FacultyCSEA style='font-size:120%;font-family:verdana;color: #000033;'>HOME PAGE</a>&nbsp&nbsp");
				   pw.println("</body>");
				   pw.println("</html>");			 
			   }
			    catch(Exception e)
