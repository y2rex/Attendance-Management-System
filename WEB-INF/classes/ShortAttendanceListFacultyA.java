...
protected void doGet(HttpServletRequest req,HttpServletResponse res)throws IOException,ServletException
 {
	...
	if(session!=null)
   {
			...
			*/
			...
			ResultSet rs1=stmt.executeQuery("select roll_no,sname,semester,attendance from attendance_sheet_cse where attendance between "+a+" and "+b+" and roll_no between '14egjcs001' and'14egjcs050' order by roll_no asc;");
					...
					do
					{
					  ...
					  */
					 ResultSet rs2=stmt.executeQuery("select count(*) from attendance_sheet_cse where roll_no between '14egjcs001' and '14egjcs050';");
					 rs2.next();
