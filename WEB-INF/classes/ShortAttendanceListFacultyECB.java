...
public class ShortAttendanceListFacultyECB extends HttpServlet
{
 Connection con;
 Statement stmt;
 
  public ShortAttendanceListFacultyECB()
  {
   super();
  }
...
protected void doGet(HttpServletRequest req,HttpServletResponse res)throws IOException,ServletException
 {
	...
	if(session!=null)
   {
			...
			*/
			...
			ResultSet rs1=stmt.executeQuery("select roll_no,sname,semester,attendance from attendance_sheet_ec where attendance between "+a+" and "+b+" and roll_no between '14egjec051' and'14egjec100' order by roll_no asc;");
					...
					do
					{
					  ...
					  */
					 ResultSet rs2=stmt.executeQuery("select count(*) from attendance_sheet_ec where roll_no between '14egjec051' and '14egjec100';");
					 rs2.next();
					 ...
					 */
					 ...
					 {
					 pw.print("<a href=ShortAttendanceListFacultyECB?pageno="+k+" style='font-size:100%;font-family:verdana;color:blue;'>"+k+"</a>&nbsp&nbsp&nbsp");
					 }
				   pw.print("<br><br><br><a href=FacultyECB style='font-size:120%;font-family:verdana;color: #000033;'>HOME PAGE</a>&nbsp&nbsp");
				    pw.print("<a href=NotificationECB style='font-size:120%;font-family:verdana;color: #000033;'>Notification</a>&nbsp&nbsp");
