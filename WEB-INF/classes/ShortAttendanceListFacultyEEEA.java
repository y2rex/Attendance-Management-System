...
public class ShortAttendanceListFacultyEEEA extends HttpServlet
{
 Connection con;
 Statement stmt;
 
  public ShortAttendanceListFacultyEEEA()
  {
   super();
  }
...
protected void doGet(HttpServletRequest req,HttpServletResponse res)throws IOException,ServletException
 {
	...
	if(session!=null)
   {
			...
			*/
			...
			ResultSet rs1=stmt.executeQuery("select roll_no,sname,semester,attendance from attendance_sheet_eee where attendance between "+a+" and "+b+"  and roll_no between '14egjee001' and '14egjee050' order by attendance asc;");
					...
					do
					{
					  ...
					  */
					 ResultSet rs2=stmt.executeQuery("select count(*) from attendance_sheet_eee where roll_no between '14egjcs001' and '14egjcs060';");
					 rs2.next();
					 ...
					 */
					 ...
					 {
					 pw.print("<a href=ShortAttendanceListFacultyEEEA?pageno="+k+" style='font-size:100%;font-family:verdana;color:blue;'>"+k+"</a>&nbsp&nbsp&nbsp");
					 }
				   pw.print("<br><br><br><a href=FacultyEEEA style='font-size:120%;font-family:verdana;color: #000033;'>HOME PAGE</a>&nbsp&nbsp");
				  pw.print("<a href=NotificationEEEA style='font-size:120%;font-family:verdana;color: #000033;'>Notification</a>&nbsp&nbsp");
