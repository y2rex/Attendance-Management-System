...
public class ShortAttendanceListFacultyMEB extends HttpServlet
{
 Connection con;
 Statement stmt;
 
  public ShortAttendanceListFacultyMEB()
  {
   super();
  }
...
protected void doGet(HttpServletRequest req,HttpServletResponse res)throws IOException,ServletException
 {
	...
	if(session!=null)
   {
			...
			*/
			...
			ResultSet rs1=stmt.executeQuery("select roll_no,sname,semester,attendance from attendance_sheet_me where attendance between "+a+" and "+b+"  and roll_no between '14egjme051' and '14egjme100' order by attendance asc;");
					...
					do
					{
					  ...
					  */
					 ResultSet rs2=stmt.executeQuery("select count(*) from attendance_sheet_me where roll_no between '14egjme051' and '14egjme100';");
					 rs2.next();
					 ...
					 */
					 ...
					 {
					 pw.print("<a href=ShortAttendanceListFacultyMEB?pageno="+k+" style='font-size:100%;font-family:verdana;color:blue;'>"+k+"</a>&nbsp&nbsp&nbsp");
					 }
				   pw.print("<br><br><br><a href=FacultyMEB style='font-size:120%;font-family:verdana;color: #000033;'>HOME PAGE</a>&nbsp&nbsp");
				   pw.print("<a href=NotificationMEB style='font-size:120%;font-family:verdana;color: #000033;'>Notification</a>&nbsp&nbsp");
